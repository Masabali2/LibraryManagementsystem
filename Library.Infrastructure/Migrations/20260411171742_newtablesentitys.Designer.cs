...
namespace Library.Infrastructure.Migrations
{
    ...
    [Migration("20260411171742_newtablesentitys")]
    partial class newtablesentitys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Domain.Entities.LocationBlock", b =>
                {
                    b.Property<int>("LocationBlockId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.Domain.Entities.Shelf", b =>
                {
                    b.Property<int>("ShelfId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.Domain.Entities.Book", b =>
                {
                    b.HasOne("Library.Domain.Entities.Shelf", "Shelf")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Library.Domain.Entities.Shelf", b =>
                {
                    b.HasOne("Library.Domain.Entities.LocationBlock", "LocationBlock")
                        .WithMany("Shelves")
                        .HasForeignKey("LocationBlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LocationBlock");
                });
